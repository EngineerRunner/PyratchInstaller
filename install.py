...
os.system("cd " + ("~/Pyratch" if t == 2 else "/Pyratch") + " && python install.py")
print("Done! Now go to localhost:5000 to use Pyratch! In the future you'll need to go to " + ("~/Pyratch" if t == 2 else "/Pyratch") + " and run it!")
